...
function Settings() {
    ...
    return (
        <div className="min-h-screen bg-gray-500 flex flex-col md:flex-row">
            <aside className="w-full md:w-[18%] bg-gray-600 p-6 md:p-8 flex flex-col space-y-6">
            ...
            <main className="w-full md:w-3/4 p-6 md:p-10 bg-gray-200">
                <Outlet context={[role]} />
            </main>
        </div>
    );
