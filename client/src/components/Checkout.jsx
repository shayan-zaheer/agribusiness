    ...
    <div>
        <div className="flex bg-[rgb(167,217,167)] rounded-lg shadow-md p-4 m-5 hover:shadow-lg transition-shadow duration-200">
            <div className="flex-1">
                ...
                <p className="text-gray-800 mb-1">
                    <strong>Enter Your Desired Quantity :</strong> <input className="rounded-sm" type="text" name="buyerquantity" id="buyerquantity" />
                </p>
            </div>
        ...
        <div className="flex justify-center mt-5 transform transition-transform duration-200 hover:scale-105" > <button className="bg-green-500 text-black font-bold border-2 p-3 rounded-md m-auto">Proceed to CheckOut</button></div>
    </div>
    );
}
