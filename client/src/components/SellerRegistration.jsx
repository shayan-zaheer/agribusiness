...
function SellerRegistration({ cities, selectedCity, setSelectedCity }) {
  ...
  const handleSubmit = async (event) => {
    ...
    const { name, username, password, mobile, city } = Object.fromEntries(formData.entries());
    ...
    >
      ...
      >
        <div className="application min-h-fit h-3/4">
          <h1 className="text-4xl font-bold text-center mb-10">Create Seller Account</h1>
          <div className="flex flex-col w-3/4">
            <label htmlFor="name" className="font-Poppins font-bold text-left mb-2">Full Name</label>
            <input type="text" name="name" className="w-full rounded border border-gray-400 py-2 px-3" />
          </div>

          <div className="flex flex-col w-3/4">
            <label htmlFor="username" className="font-Poppins font-bold text-left mb-2">Username</label>
          ...
          <div className="flex flex-col w-3/4">
            <label htmlFor="mobile" className="font-Poppins font-bold text-left mb-2">Mobile Number</label>
            <input type="number" name="mobile" className="w-full rounded border border-gray-400 py-2 px-3" />
          </div>

          <div className="flex flex-col w-3/4">
            <label htmlFor="city" className="font-Poppins font-bold text-left mb-2">Select City</label>
            <select
              name="city"
              value={selectedCity}
          ...
          <button type="submit" className="bg-[#4eb0aa] hover:bg-[#225855] text-white font-bold py-2 px-4 rounded w-1/2 md:w-1/2 mt-4 ml-10" >
            Register
          </button>

          <div className="mt-4 ml-5">
            Already Have An Account?{" "}
            <Link to="/login?user=seller" className="text-blue-600 underline">Sign In</Link>
          </div>
        </div>
      </Form>
    </div>
...
{/* 
                ...
                <button
                    type="submit"
                    className="bg-[#6E9794] hover:bg-[#70aca8] text-white font-bold py-2 mx-auto rounded w-1/2 md:w-1/2 mt-4"
                >
                    Register
                </button>
